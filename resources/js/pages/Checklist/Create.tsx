...
export default function Checklists({ categories, cars }: { categories: Category[]; cars: Car[] }) {
    ...
    const { data, setData, post, errors, setError } = useForm<ChecklistForm>({
        description: '',
        id_category: '',
        id_car: '',
        tasks: [],
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        setData('tasks', taskFields);

        console.log('payload: ', { ...data, tasks: taskFields });
                            ...
                            <div className="flex flex-1 flex-col gap-4">
                                ...
                                <div className="flex w-2xs flex-col gap-2">
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            {cars.map((car) => (
                                                <SelectItem key={car.id} value={car.id.toString()} className="font-bold">
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    {taskFields.map((task, index) => (
                                        <div className="flex w-2/3 flex-row gap-2" key={index}>
                                            <Input
                                                value={task}
                                    ...
                                    <InputError message={errors.tasks}></InputError>
                                </div>
                            </div>
                        </div>
